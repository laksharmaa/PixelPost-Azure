...
const Home = () => {
  ...
  return (
    <section className='max-w-xl max-auto'>
      <div>
        <h1 className='font-extrabold text-black text-[32px]'>The Community Showcase</h1>
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>Browse through the image of imaginative images generated by AI</p>
      </div>
      <div className='mt-16'>
        <FormField />
      </div>
